...
import pt.up.fe.ldts.frogger.element.command.MoveLeft;
import pt.up.fe.ldts.frogger.element.command.MoveRight;
import pt.up.fe.ldts.frogger.element.factory.MovableElementsFactory;
import pt.up.fe.ldts.frogger.element.movable.*;
import pt.up.fe.ldts.frogger.element.nonmovable.Grass;
import pt.up.fe.ldts.frogger.element.nonmovable.Road;
import pt.up.fe.ldts.frogger.element.nonmovable.Sidewalk;
import pt.up.fe.ldts.frogger.element.nonmovable.Water;
