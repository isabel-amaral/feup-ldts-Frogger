...
public class ArenaTest {
    ...
    public void drawTextTest() {
        arena.drawText(screen.newTextGraphics(), new Position(1, 1), "Hello ldts.frogger.Frog Friends!", "#336699");
        ...
        Mockito.verify(graphics, Mockito.times(1)).putString(1, 1, "Hello ldts.frogger.Frog Friends!");
    }
